 ...
 * psp_account property, not a process-wide flag — see the ADR for the
 * full rationale. `mode` defaults to 'sandbox' so existing rows (and
 * anyone inserting without thinking about it) land on the safe side.
 */
